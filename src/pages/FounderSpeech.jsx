    ...
    <main>
      ...
      <section className="bg-gradient-to-br from-[#1a2e3b] to-[#426780] text-white py-16">
        <div className="max-w-6xl mx-auto px-5">
          <span className="text-[#7de896] text-xs font-semibold uppercase tracking-widest block mb-3">Founder's Address</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-5">
          ...
          <div className="flex items-center gap-4 bg-[#f4f8f5] rounded-2xl p-5 mb-10">
            ...
            />
            <div>
              <p className="font-bold text-[#1a2e3b] text-base">Mr. Walter Bamidele Olatunji</p>
              <p className="text-[#39A84F] text-sm font-medium">IWRM Expert & Founder, WBOF</p>
              <p className="text-gray-400 text-xs mt-1">World Water Day Address, 2026</p>
            </div>
          </div>

          {/* Speech */}
          <div className="prose max-w-none">
            <p className="text-gray-600 leading-relaxed mb-6 font-medium">Dear everyone,</p>
            ...
            <div className="space-y-5 text-gray-600 leading-relaxed">
              ...
              <div className="space-y-4 my-6">
                {principles.map(pr => (
                  <div key={pr.label} className="flex items-start gap-3 bg-[#f4f8f5] p-4 rounded-lg">
                    <span className="w-6 h-6 rounded-full bg-[#39A84F] text-white flex items-center justify-center text-xs flex-shrink-0 mt-0.5">✓</span>
              ...
              <p className="font-semibold text-[#1a2e3b] text-base mt-6">Thank you and happy celebration!!!</p>
            </div>
          </div>
        </div>
      </section>
